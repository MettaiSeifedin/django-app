...
if IS_HEROKU_APP:
    ...
    ALLOWED_HOSTS = [".localhost", "127.0.0.1", "[::1]", "0.0.0.0", "django-app-using-cicd.onrender.com"]
...
# Modify storage based on environment (production, test, etc.)
if "test" in sys.argv:
    # Use basic static files storage during tests
